            ...
            <div class="overlay-dialog overlay-dialog--signin overlay-dialog--animate js-overlayDialog" tabindex="-1">
              ...
              <br/>
                ...
                <div class="overlay-content"><?php _e('Sign in to','pluginhunt');?>  <?php bloginfo('name'); ?> <?php _e('or create an account','pluginhunt');?></div>
                                ...
                                <a href="<?php echo $surl;?>/login/?loginSocial=facebook" onclick="window.location = '<?php echo wp_login_url(); ?>?loginFacebook=1&redirect='+window.location.href; return false;">
                                <div class='ph-fb'><i class="fa fa-facebook"></i><?php _e('Sign in with Facebook','pluginhunt'); ?></div></a>
                                <br/>
                                <a href="<?php echo $surl;?>/login/?loginSocial=twitter" onclick="window.location = '<?php echo wp_login_url(); ?>?loginTwitter=1&redirect='+window.location.href; return false;">
