			 ...
			 <div class='post-header' style="background-image: url('<?php echo $image[0]; ?>')">
			 	<div class='post-header-shadow'>
				 	<div class='container-title'>
				 		<span class='post-title-single'><?php the_title(); ?></span>
				 		<div class='post-description-short'><?php // echo wp_trim_words( $post->post_content , 35, '...' ); ?></div>
				 		
				 		<div class='reddit-wrapper reddit-discuss'>
		...
		<div class = "row post-detail">
			 <div class='full-width-ph'>
			 	<section class="col-md-8 ph-lhs">
					...
					<?php if($media==''){ ?>
						<div class='pm'>
							<div class="post-detail placeholder media-placeholder"><span><?php _e('No media yet. Be the first one to','pluginhunt'); ?>&nbsp;</span><a class='postmedia' data-pid='<?php echo $post->ID;?>' href="#"><?php _e('add media','pluginhunt'); ?></a><?php echo outputmedia_pop_sin();  ?><span>.</span></div>
