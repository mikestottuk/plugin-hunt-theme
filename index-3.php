 		...
 		<div class='sign-up-cta'>
 		  ...
 		  <div class='ph_socials'>
               ...
               <div class='ph-soc-block'>
               	<ul class='ps-main'>
                	<li class='tw ph-sm'><a href="<?php echo $surl;?>/login/?loginSocial=twitter" onclick="window.location = '<?php echo wp_login_url(); ?>?loginTwitter=1&redirect='+window.location.href; return false;">
